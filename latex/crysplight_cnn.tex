...
pedagogical style. The study establishes the idealized-conditions baseline of
the CryspLight reconstruction program; Compton topologies and timing
information are the natural extensions.
\end{abstract}
...
\begin{enumerate}
  \item \textbf{Compton topologies.} Events with one or more Compton scatters
    produce multi-site light maps; the per-event truth (positions and energies
    of the first two interactions, interaction type) is already in the data
    files, enabling both a classification stage (single-site against
    multi-site) and a regression of the first-interaction position.
