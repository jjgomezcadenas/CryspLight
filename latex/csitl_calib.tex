...
\title{Calibration of the CryspLight optical model on \csitl{} and cold pure CsI:\\
the absorption/scattering split of the measured extinction}
\author{J.J.~G\'omez-Cadenas \and Claude (Anthropic)}
\date{July 13, 2026 \\[2mm] \small Version 0.2 --- calibration note (phase 1)}
...
bare-crystal re-measurement or a transmittance scan. All numbers regenerate from
\texttt{scripts/csitl\_calib.jl} and \texttt{scripts/soleti\_calib.jl} with their
\texttt{runs/*.toml} campaigns.
\end{abstract}
...
\begin{itemize}
  ...
  \item \texttt{data/csitl.toml}, \texttt{data/csi.toml} --- the calibrated parameters,
